...
const u8* const sprite_by_type[4] = {sprite_duck_left_1, sprite_girador_1, sprite_gusano_out, sprite_disparador_front};
...
const TMap all_maps_compressed[] = {
	CREATE_MAP(16, 22, G_c_map_0, 0xFF,6,0xFF,0xFF, 0, 0x0000, 0x0000, 0x0000, 0x0000),
	...
	CREATE_MAP(28, 20, G_c_map_16, 8,0xFF,0xFF,0xFF, 3, &enemies_map_16, 0x0000, 0x0000, 0x0000),
	...
	CREATE_MAP(15, 20, G_c_map_20, 15,25,0xFF,0xFF, 0, 0x0000, 0x0000, &door_map_20, 0x0000),
	...
	CREATE_MAP(22, 24, G_c_map_26, 0xFF,32,0xFF,0xFF, 2, &enemies_map_26, 0x0000, 0x0000, 0x0000),
	...
	CREATE_MAP(32, 20, G_c_map_29, 0xFF,0xFF,28,0xFF, 4, &enemies_map_29, &portal_map_29, &door_map_29, 0x0000),
	CREATE_MAP(17, 20, G_c_map_30, 24,0xFF,0xFF,31, 0, 0x0000, 0x0000, 0x0000, 0x0000),
	CREATE_MAP(21, 20, G_c_map_31, 0xFF,0xFF,30,0xFF, 0, 0x0000, 0x0000, 0x0000, 0x0000),
	CREATE_MAP(29, 20, G_c_map_32, 26,0xFF,0xFF,33, 3, &enemies_map_32, 0x0000, 0x0000, 0x0000),
	CREATE_MAP(25, 20, G_c_map_33, 27,0xFF,32,34, 4, &enemies_map_33, 0x0000, 0x0000, 0x0000),
...
void map_init_game()
{
	// 0 because is the first map we need to load when game starts.
   	change_map_aux(2);
}
...
{
	if(next_maps[direction] != 0xFF)
	{
		change_map_aux(next_maps[direction]);
		load_hero(direction);
		camera_run();
	}
}
